    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          AppTextField(label: 'Full name', hint: 'Enter your name', controller: nameController),
          const SizedBox(height: 18),
          AppTextField(label: 'Email address', hint: 'Enter your email', controller: emailController, keyboardType: TextInputType.emailAddress),
          const SizedBox(height: 18),
